...
```
  ...
  Using ` unquote/1` on the same expression multiple times results in re-evaluation and that can have unintended consequences. Let’s update the example to use bind_quoted and see what we get:
